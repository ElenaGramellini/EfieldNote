...
We find the same electric field value of 486.5 V/cm using both a single line drawing and using anode to cathode piercing tracks with a drift velocity of 1.51 mm/$\mu s$ and a drift time of 311.4 $\mu s$.
